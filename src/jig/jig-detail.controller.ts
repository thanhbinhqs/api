...
export class JigDetailController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Jig detail đã được tạo thành công',
    type: JigDetail,
  })
  async create(
    @Body() createJigDetailDto: CreateJigDetailDto,
  ): Promise<JigDetail> {
  ...
  @ApiResponse({
    status: 200,
    description: 'Danh sách jig details',
    type: PaginatedResult,
  })
  async findAll(
    @Query() filterDto: JigDetailFilterDto,
  ...
  @ApiResponse({
    status: 200,
    description: 'Thông tin jig detail',
    type: JigDetail,
  })
  ...
  async findByMesCode(
    @Param('mesCode') mesCode: string,
  ): Promise<JigDetail | null> {
  ...
  @ApiResponse({
    status: 200,
    description: 'Danh sách jig details của jig',
    type: [JigDetail],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Danh sách jig details cần bảo trì',
    type: [JigDetail],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Jig detail đã được cập nhật',
    type: JigDetail,
  })
  async update(
    @Param('id') id: string,
    @Body() updateJigDetailDto: UpdateJigDetailDto,
  ): Promise<JigDetail> {
  ...
  @ApiResponse({
    status: 200,
    description: 'Trạng thái jig detail đã được cập nhật',
    type: JigDetail,
  })
  async updateStatus(
    @Param('id') id: string,
    @Body('status') status: JigStatus,
  ): Promise<JigDetail> {
  ...
  @ApiResponse({
    status: 200,
    description: 'Vị trí jig detail đã được cập nhật',
    type: JigDetail,
  })
  async updateLocation(
    ...
    return await this.jigDetailService.updateLocation(
      id,
      locationId || null,
      lineId || null,
      vendorId || null,
  ...
  @ApiResponse({
    status: 200,
    description: 'Ngày bảo trì đã được cập nhật',
    type: JigDetail,
  })
  async updateMaintenanceDate(
    @Param('id') id: string,
    @Body('maintenanceDate') maintenanceDate: Date,
  ): Promise<JigDetail> {
    return await this.jigDetailService.updateMaintenanceDate(
      id,
      maintenanceDate,
    );
  }
  ...
  @HasPermission(Permission.JIG_DETAIL_UPDATE)
  @ApiOperation({
    summary: 'Cập nhật trạng thái hàng loạt cho nhiều jig details',
  })
  @ApiResponse({
    status: 200,
  ...
  async batchUpdateStatus(
    @Body() batchUpdateDto: BatchUpdateJigDetailStatusDto,
  ) {
  ...
  async setDefaultLocations(
    ...
    return await this.jigDetailService.setDefaultLocations(
      id,
      body.locationId,
      body.lineId,
      body.vendorId,
  ...
  @ApiResponse({
    status: 200,
    description: 'Jig detail đã được khôi phục về vị trí mặc định',
  })
