...
export class ProjectService {
  ...
  async findAllProjects(
    ...
    if (friendlyName) {
      queryBuilder.andWhere('project.friendlyName ILIKE :friendlyName', {
    ...
    if (description) {
      queryBuilder.andWhere('project.description ILIKE :description', {
  ...
  private async checkUniqueness(
    ...
    queryBuilder.where('(project.name = :name OR project.slug = :slug)', {
      name,
      slug,
    });
